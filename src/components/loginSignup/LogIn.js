...
class LogIn extends Component {
    ...
    handleEmailLogin( ref ) {
        ref.props.navigation.navigate( "LogInWithEmail" );
    }

    render() {
        return (
            <View style={[{ backgroundColor: this.props.theme.primaryBackgroundColor }, styles.container]}>
                <CustomComponents.AppLogo size={27} first={strings.GOLD} second={strings.STREAM} style={{ marginBottom: '55%' }} />
                <View style={[{ backgroundColor: this.props.theme.color2 }, styles.lognMethodsContainer]}>
                    ...
                    <CustomComponents.CustomText value={strings.LOGIN_WITH} style={{ fontSize: 18, marginBottom: 19 }} />
