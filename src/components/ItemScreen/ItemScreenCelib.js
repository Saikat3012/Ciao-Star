  ...
  return (
    <ScrollView
      ...
      <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
        <TouchableOpacity onPress={() => { navigation.navigate( "FocusCelibrity" )}}>
          <View style={storyCardStyles.container}>
            <View style={[storyCardStyles.story, { opacity: 0.5 }]}>
              <Image source={ImgAssets.banner1} />
            </View>
            <View style={[storyCardStyles.profileHolder]}>
              <Text style={{ fontSize: 25 }}>+</Text>
              {/* <Image source={ImgAssets.defaultUserAvatar} style={storyCardStyles.profilePic} /> */}
            </View>
          </View>
        </TouchableOpacity>
