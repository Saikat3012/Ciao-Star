  ...
  const rightHeaderChield = () => (
    <View style={styles.rightHeaderChieldContainer}>
      <TouchableOpacity
        ...
        {theme.type == 'dark' ? (
          <IoniconsIcon name="notifications-outline" size={25} color="#fff" />
        ) : (
          <IoniconsIcon name="notifications-outline" size={25} color="#000" />
        )}
      </TouchableOpacity>

      <TouchableOpacity onPress={() => handleSettingsClick()}>
        {theme.type == 'dark' ? (
          <IoniconsIcon name="settings" size={25} color="#fff" />
        ) : (
          <IoniconsIcon name="settings" size={25} color="#000" />
        )}
      </TouchableOpacity>
    </View>
  );
    ...
    <ScrollView
      ...
      <View style={styles.featureContainer}>
        ...
        <View style={styles.featureInnerContainer}>
          <View style={styles.features}>
            {theme.type == 'dark' ? (
              <MaterialIcons name="touch-app" size={35} color="#fff" />
            ) : (
              <MaterialIcons name="touch-app" size={35} color="#000" />
            )}
            <CustomComponents.CustomText
              value={texts.SELECT}
          ...
          <View style={styles.features}>
            <Image
              source={
                theme.type == 'dark' ? ImgAssets.tick2Dark : ImgAssets.tick2Dark
              }
      ...
      <View style={styles.channelsContainer}>
        <View style={styles.channelsContent}>
          <Image
            source={theme.type == 'dark' ? ImgAssets.tvDark : ImgAssets.tvDark}
      ...
      <View style={styles.featureContainer}>
        <View style={styles.featureInnerContainer}>
          ...
          <View style={styles.features}>
            <Image
              source={
                theme.type == 'dark' ? ImgAssets.chatDark : ImgAssets.chatDark
              }
              style={styles.featureIcon}
            />
            <CustomComponents.CustomText
          ...
          <View style={styles.features}>
            <Image
              source={
                theme.type == 'dark' ? ImgAssets.giftDark : ImgAssets.giftDark
              }
              style={styles.featureIcon}
            />
            <CustomComponents.CustomText
      ...
      <Image style={styles.suitableBanner} source={ImgAssets.banner3} />
      ...
      <Image style={styles.bottomBanner} source={ImgAssets.banner2} />
    </ScrollView>
  );
};
