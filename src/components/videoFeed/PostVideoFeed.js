...
class PostVideoFeed extends Component {
    constructor( props ) {
        super( props );
    }
    state = {
        ...
        return (
            <View style={[styles.container, { backgroundColor: this.props.theme.primaryBackgroundColor }]}>
                ...
                <View style={styles.featuresContainer}>
                    <TouchableOpacity style={styles.eachFeaturesContainer}>
                        <MaterialIcons name="photo-library" size={20} color={this.props.theme.primaryTextColor} />
                        <CustomComponents.CustomText value="Share Photos" style={styles.eachFeatuesText} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.eachFeaturesContainer}>
                        <MaterialIcons name="mic-none" size={20} color={this.props.theme.primaryTextColor} />
                        <CustomComponents.CustomText value="Mute/Unmute" style={styles.eachFeatuesText} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.eachFeaturesContainer}>
                        <MaterialIcons name="flip-camera-android" size={20} color={this.props.theme.primaryTextColor} />
                        <CustomComponents.CustomText value="Turn Camera" style={styles.eachFeatuesText} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.eachFeaturesContainer}>
                        <Entypo name="emoji-flirt" size={20} color={this.props.theme.primaryTextColor} />
                        <CustomComponents.CustomText value="Filters" style={styles.eachFeatuesText} />
                    </TouchableOpacity>
                </View>
                <TouchableOpacity style={{
                    borderRadius: 500,
                    borderWidth: 2,
                    borderColor: this.props.theme.primaryTextColor,
                    padding: 18,
                    position: 'absolute',
                    bottom: 20
                }}>
...
export default connect( mapStatetoProps, mapDispatchToProps )( PostVideoFeed );
